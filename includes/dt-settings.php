...
function dt_admin() {
	...
	<div class="wrap dt">
							...
							<ul>
								...
								if (function_exists('curl_init')) { 
									...
									if($dt_twitter_oauth_access_token && $dt_twitter_oauth_access_token_secret && $dt_twitter_consumer_key && $dt_twitter_consumer_secret) {
										...
										$oauthdetails=1;
										?>
										<li><a id="tab-section-general" rel="general" href="#" <?php if ($tab=="general") {?>class="active"<?php } ?>><?php _e('General Settings','dt_twitter'); ?></a></li>
										<li><a id="tab-section-display" rel="display" href="#" <?php if ($tab=="display") {?>class="active"<?php } ?>><?php _e('Automatic Styling','dt_twitter'); ?></a></li>
										<li><a id="tab-section-manual" rel="manual" href="#" <?php if ($tab=="manual") {?>class="active"<?php } ?>><?php _e('Manual Styling','dt_twitter'); ?></a></li>
										<li><a id="tab-section-integrate" rel="integrate" href="#" <?php if ($tab=="integrate") {?>class="active"<?php } ?>><?php _e('How To Integrate','dt_twitter'); ?></a></li>
									<?php
									//Otherwise - Disable These Until Details Completed
									} else {
									?>
										<li><span class="inactive"><?php _e('General Settings','dt_twitter'); ?></span></li>
										<li><span class="inactive"><?php _e('Automatic Styling','dt_twitter'); ?></span></li>
										<li><span class="inactive"><?php _e('Manual Styling','dt_twitter'); ?></span></li>
										<li><span class="inactive"><?php _e('How To Integrate','dt_twitter'); ?></span></li>
									<?php
								...
								//Otherwise - CURL Not Available
									...
									?>
									<li><a id="tab-section-application" rel="application" href="#" <?php if (!$tab || $tab=="application") {?>class="active"<?php } ?>><?php _e('Error: cURL Not Available','dt_twitter'); ?></a></li>
								<?php
								//End CURL Check
								}
								?>
						...
						<div class="right-area">									
							...
							<div <?php if (!$tab || $tab=="application") {?>style="display: block;"<?php } else { ?>style="display: none;"<?php } ?> class="setting-right-section" id="setting-application">
								...
								<div class="dt-setting">
									...
									<div class="dt-setting">
										...
										<?php if ($_SESSION['application_message']!="") { ?><legend class="validation"><?php _e('Validation Error','dt_twitter'); ?></legend><?php } else {?><legend class="validation"><?php _e('Success','dt_twitter'); ?></legend><?php } ?>
									...
									<input class="button-primary dtbutton" type="submit" name="submit" tabindex="1" value="<?php _e('Update Application Options','dt_twitter'); ?>" />
							...
							<div <?php if ($tab=="general") {?>style="display: block;"<?php } else { ?>style="display: none;"<?php } ?> class="setting-right-section" id="setting-general">
								...
								<div class="dt-setting">
									...
									<div class="dt-setting">
										<div>
										<fieldset class="rounded">
										<?php if ($_SESSION['general_message']!="") { ?><legend class="validation"><?php _e('Validation Error','dt_twitter'); ?></legend><?php } else {?><legend class="validation"><?php _e('Success','dt_twitter'); ?></legend><?php } ?>
										<div class="dt-ad-section-settings"></div>
										<div class="dt-setting type-text validation" id="setting_site_title">
									...
									<div class="dt-setting">	
										...
										<legend><?php _e('General Settings','dt_twitter'); ?></legend>
											...
											<div class="dt-setting type-text" id="setting_site_title">
							                    ...
							                    <option value="1500"<?php if(get_option('dt_twitter_twitterupdate')==1500) { echo ' selected="selected"'; } ?>><?php _e('25 Minutes','dt_twitter'); ?></option>
							                    <option value="1200"<?php if(get_option('dt_twitter_twitterupdate')==1200) { echo ' selected="selected"'; } ?>><?php _e('20 Minutes','dt_twitter'); ?></option>
							                    <option value="900"<?php if(get_option('dt_twitter_twitterupdate')==900) { echo ' selected="selected"'; } ?>><?php _e('15 Minutes','dt_twitter'); ?></option>
							                    <option value="600"<?php if(get_option('dt_twitter_twitterupdate')==600) { echo ' selected="selected"'; } ?>><?php _e('10 Minutes','dt_twitter'); ?></option>
							                    <option value="300"<?php if(get_option('dt_twitter_twitterupdate')==300) { echo ' selected="selected"'; } ?>><?php _e('5 Minutes','dt_twitter'); ?></option>
							                    </select>
												</div>
									...
									<div class="dt-setting">	
										<fieldset class="rounded">
										<legend><?php _e('Header Settings','dt_twitter'); ?></legend>
									...
									<div class="dt-setting">
										<fieldset class="rounded">
										<legend><?php _e('Single Tweet Settings (What To Display For Each Tweet)','dt_twitter'); ?></legend>
									...
									<input class="button-primary dtbutton" type="submit" name="submit" tabindex="1" value="<?php _e('Update General Options','dt_twitter'); ?>" />
							...
							<div <?php if ($tab=="display") {?>style="display: block;"<?php } else { ?>style="display: none;"<?php } ?> class="setting-right-section" id="setting-display">
								...
								<div class="dt-setting">
									...
									<div class="dt-setting">
										<div>
										<fieldset class="rounded">
										<?php if ($_SESSION['display_message']!="") { ?><legend class="validation"><?php _e('Validation Error','dt_twitter'); ?></legend><?php } else {?><legend class="validation"><?php _e('Success','dt_twitter'); ?></legend><?php } ?>
										<div class="dt-ad-section-settings"></div>
										<div class="dt-setting type-text validation" id="setting_site_title">
									...
									<div class="dt-setting">
										<fieldset class="rounded">
										<legend><?php _e('Main Container Settings','dt_twitter'); ?></legend>
									...
									<div class="dt-setting">
										<fieldset class="rounded">
										<legend><?php _e('Tweet Settings','dt_twitter'); ?></legend>
									...
									<div class="dt-setting"<?php if(get_option('dt_twitter_images')==0) { echo ' style="display:none;"'; } ?>>
										<fieldset class="rounded">
										<legend><?php _e('Image Settings','dt_twitter'); ?></legend>
											...
											<div class="dt-setting type-text">
							                    ...
							                    <option value="25"<?php if(get_option('dt_twitter_image_size')==25) { echo ' selected="selected"'; } ?>><?php _e('25px Width x 25px Height','dt_twitter'); ?></option>
							                    <option value="30"<?php if(get_option('dt_twitter_image_size')==30) { echo ' selected="selected"'; } ?>><?php _e('30px Width x 30px Height','dt_twitter'); ?></option>
							                    <option value="35"<?php if(get_option('dt_twitter_image_size')==35) { echo ' selected="selected"'; } ?>><?php _e('35px Width x 35px Height','dt_twitter'); ?></option>
							                    <option value="40"<?php if(get_option('dt_twitter_image_size')==40) { echo ' selected="selected"'; } ?>><?php _e('40px Width x 40px Height','dt_twitter'); ?></option>
							                    <option value="45"<?php if(get_option('dt_twitter_image_size')==45) { echo ' selected="selected"'; } ?>><?php _e('45px Width x 45px Height','dt_twitter'); ?></option>
							                    <option value="50"<?php if((get_option('dt_twitter_image_size')==50) || (!get_option('dt_twitter_image_size'))) { echo ' selected="selected"'; } ?>><?php _e('50px Width x 50px Height','dt_twitter'); ?></option>
							                    </select>
							                    <br class="clearer" />
												</div>
									...
									<input class="button-primary dtbutton" type="submit" name="submit" tabindex="1" value="<?php _e('Update Styling Options','dt_twitter'); ?>" />
							...
							<div <?php if ($tab=="manual") {?>style="display: block;"<?php } else { ?>style="display: none;"<?php } ?> class="setting-right-section" id="setting-manual">
								...
								<div class="dt-setting">
									...
									<div class="dt-setting">	
										<fieldset class="rounded">
										<legend><?php _e('Manual Styling','dt_twitter'); ?></legend>
							...
							<div <?php if ($tab=="integrate") {?>style="display: block;"<?php } else { ?>style="display: none;"<?php } ?> class="setting-right-section" id="setting-integrate">
								...
								<div class="dt-setting">
									...
									<div class="dt-setting">	
										<fieldset class="rounded">
										<legend><?php _e('How To Integrate','dt_twitter'); ?></legend>
		...
		<p id="dt-trademark"><em><?php _e('Created By Dan Perkins @ Digicution','dt_twitter'); ?></em></p>
